...
#' @param logo_path url, local file for the logo, or one of the built in logos. Can be a character string in c('brookings','es', 'gs', 'fp', 'metro', 'global', 'bi', 'bc', 'cc', 'ccf', 'ceaps', 'cepm', 'chp', 'cmep', 'csd', 'cti', 'crm', 'cue', 'cuse', 'doha', 'hc', 'tsinghua', 'thp')
...
#' @import magick
#'
add_logo <- function(plot_path, logo_path =  c('brookings','es', 'gs', 'fp', 'metro', 'global', 'bi', 'bc', 'cc', 'ccf', 'ceaps', 'cepm', 'chp', 'cmep', 'csd', 'cti', 'crm', 'cue', 'cuse', 'doha', 'hc', 'tsinghua', 'thp'), logo_position = 'bottom right', logo_scale = 5, height_padding = 0.045, width_padding = 0.02){
  ...
  if(logo_path %in% c('brookings','es', 'gs', 'fp', 'metro', 'global', 'bi', 'bc', 'cc', 'ccf', 'ceaps', 'cepm', 'chp', 'cmep', 'csd', 'cti', 'crm', 'cue', 'cuse', 'doha', 'hc', 'tsinghua', 'thp')){
    logo_path <- match.arg(logo_path)

    logo_path <- system.file(package = 'ggTHP2', glue::glue('logos/{logo_path}.png'))
  } else{
    logo_path
  }
  # read in raw images
